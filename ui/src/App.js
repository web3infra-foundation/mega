...
test('when dragging a copy and cancel gets called, default does not revert', function (t) {test('when dragging a copy and cancel gets called, default does not revert', function (t) {test('when dragging a copy and cancel gets called, default does not revert', function (t) {
  var div = document.createElement('div');
