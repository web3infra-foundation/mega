...
rsync --delete --archive $MEGA_DIR/extensions/cratespro_common/repo_import/ $INFRA_DIR/project/crates-pro/repo_import/
rsync --delete --archive $MEGA_DIR/extensions/cratespro_common/database/ $INFRA_DIR/project/crates-pro/database/
rsync --delete --archive $MEGA_DIR/extensions/cratespro_common/model/ $INFRA_DIR/project/crates-pro/model/
