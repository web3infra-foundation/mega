...
const ComparePage = () => {
  ...
  const fetchVersionData = useCallback(
    async (version: string): Promise<VersionData | null> => {
      try {
  ...
  const VersionSelector = ({
    ...
    <div className='relative'>
      <button
        onClick={onToggle}
        className='flex items-center space-x-2 transition-colors hover:bg-gray-50'
        style={{
          display: 'flex',
          width: '140px',
          height: '40px',
      ...
      <CrateInfoLayout versions={versions}>
        <div className='flex justify-center'>
          <div className='w-[1370px] px-8 py-4' style={{ paddingLeft: '32px', paddingRight: '32px' }}>
            {/* 左右两个卡片 */}
            <div className='relative flex justify-start gap-24'>
              {/* 交换按钮 - 位于顶部中间 */}
              <div
                className='absolute left-1/2 top-0 z-10 -translate-x-1/2 -translate-y-1/2 transform'
              ...
              >
                ...
                <div className='mb-8'>
                  ...
                  <div className='space-y-3'>
                    <div>
                      <div
                        className='mb-1 text-xs uppercase text-gray-500'
                        style={{
                          alignSelf: 'stretch',
                          color: '#000509e3',
                          fontFamily: '"HarmonyOS Sans SC"',
                      ...
                      <div
                        ...
                        style={{
                          ...
                          lineHeight: '20px',
                          backgroundColor:
                            leftVersion.license !== rightVersion.license ? getHighlightColor('updated') : 'transparent',
