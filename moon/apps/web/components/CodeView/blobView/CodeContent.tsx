import Editor from '../TreeView/editor/Editor'
...
const CodeContent = ({ fileContent }:any) => {
    ...
    const handleLineNumberClick = (lineIndex: string | number) => {
        setShowEditor(!showEditor);
        const lineNumberButton = document.getElementsByClassName('codeLineNumber')[lineIndex as number];
