    ...
    <div className='flex flex-col gap-3'>
      <div className='rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md'>
        <div className='mb-3 flex items-center justify-between'>
          <span className='text-xs font-semibold tracking-wide text-gray-500'>Merge Count</span>
        </div>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div className='flex flex-col pl-3'>
            <span className='text-2xl font-bold text-gray-900'>{stats.merged_count}</span>
            <span className='text-xs text-gray-500'>Merged in queue</span>
          </div>
        </div>
      </div>
