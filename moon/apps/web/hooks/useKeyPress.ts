...
function isInputDOMNode(event: KeyboardEvent | ReactKeyboardEvent): boolean {
...
export const useKeyPress = (keyCode: KeyCode | null = null, options: UseKeyPressOptions = { target: doc }): boolean => {
  ...
  }, [keyCode, keyCodes, keysToWatch, options?.target, setKeyPressed])
