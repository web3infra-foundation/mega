...
impl MegaModelConverter {
    ...
    let sea_tree: mercury::internal::model::sea_models::mega_tree::Model = mercury::internal::model::sea_models::mega_tree::Model::from(root_tree.to_owned());
    ...
    fn traverse_for_update(&self, tree: &Tree) {
        for item in &tree.tree_items {
            if item.mode == TreeItemMode::Tree {
                ...
                let sea_tree: mercury::internal::model::sea_models::mega_tree::Model = mercury::internal::model::sea_models::mega_tree::Model::from(child_tree.to_owned());
                let mut mega_tree: mega_tree::Model = callisto::mega_tree::Model::from(sea_tree);
                mega_tree.commit_id = self.commit.id.to_string();
                self.mega_trees
                    .borrow_mut()
                ...
                let sea_blob: mercury::internal::model::sea_models::mega_blob::Model = mercury::internal::model::sea_models::mega_blob::Model::from(blob);
                ...
                let sea_raw: mercury::internal::model::sea_models::raw_blob::Model = mercury::internal::model::sea_models::raw_blob::Model::from(blob);
